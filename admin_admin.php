...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            ...
            <hr>
            <a href="tambah_admin.php" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>Tambah Admin</a>
            ...
            <?php
                ...
                echo "
                    ...
                    <td colspan='2' class='text-center'><a href='edit_admin.php?id=$row[id_admin]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a>
