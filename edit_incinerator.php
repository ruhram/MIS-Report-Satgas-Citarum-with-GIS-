...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-dumpster-fire mr-2"></i> Tambah Incinerator</h3>
            <hr>
            <form action="#" method="post">
                <?php
                    $id = $_GET['id'];
                    $_SESSION['id'] = $id;
                    $edit = "SELECT * FROM `incinerator` WHERE `id_incinerator` = '$id'";
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="id">ID Incinerator</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Incinerator" id="id" value="<?php echo $row['id_incinerator']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="jumlah">Jumlah Incinerator</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="jumlah" class="form-control" placeholder="Jumlah Incinerator" id="jumlah" value="<?php echo $row['jumlah']?>">
                        </div>
                    </div>
                </div>

                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="edit_incinerator">Submit</button>
                </div>
            </form>
            </div>
    </div>
