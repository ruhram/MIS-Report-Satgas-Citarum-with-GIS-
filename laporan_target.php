...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-bullseye"></i> Laporan Harian</h3>
            <hr>
            <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <select name="tanggal" id="tanggal">
                            ...
                            <?php
                                ...
                                echo "<option value='$row[id_rencana]'>$row[tanggal]</option>";
                                }
                            ?> 
                        </select>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <textarea rows="2" cols="10" name="kendala" class="form-control" placeholder="Kendala" id="kendala"></textarea>
                        </div>
                    </div>
                </div>
