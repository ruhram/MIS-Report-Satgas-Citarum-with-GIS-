  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-monument mr-2"></i> Tambah Wilayah Subsektor</h3>
            <hr>
            <form action="#" method="post" enctype="multipart/form-data">
                <?php
                    $id = $_GET['id'];
                    $edit = "SELECT * FROM `wilayah_subsektor` WHERE `id_wilayahsubsektor` = '$id'";
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="id">ID Wilayah Subsektor</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Wilayah Subsektor" id="id" value="<?php echo $row['id_wilayahsubsektor']?>">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-9">
                            <select name="sektor" id="sektor">
                                ...
                                <?php
                                    ...
                                    echo "<option value='$rows[id_sektor]'>$rows[id_sektor]</option>";
                                    }
                                ?>
                            </select>
                        </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                        <select name="subsektor" id="sektor">
                ...
                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="edit_wilayahsubsektor">Submit</button>
                </div>
            </form>
        </div>
    </div>
