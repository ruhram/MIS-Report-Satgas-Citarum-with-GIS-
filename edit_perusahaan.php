...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-building mr-2"></i>Edit Perusahaan</h3>
            <hr>
            <form action="#" method="post">
            <?php
                    $id = $_GET['id'];
                    $_SESSION['id'] = $id;
                    $edit = "SELECT * FROM `perusahaan` WHERE `id_perusahaan` = '$id'";
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Perusahaan" id="id" value="<?php echo $row['id_perusahaan']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="nama" class="form-control" placeholder="Nama Perusahaan" id="nama" value="<?php echo $row['nama_perusahaan']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="latitude" class="form-control" placeholder="Latitude" id="latitude" value="<?php echo $row['latitude']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="longitude" class="form-control" placeholder="Longitude" id="longitude" value="<?php echo $row['longitude']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <textarea rows="2" cols="10" type="text" name="keterangan" class="form-control" placeholder="keterangan" id="keterangan"><?php echo $row['keterangan']?></textarea>
                        </div>
                    </div>
                </div>

                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="edit_perusahaan">Submit</button>
                </div>
            </form>
            </div>
    </div>
