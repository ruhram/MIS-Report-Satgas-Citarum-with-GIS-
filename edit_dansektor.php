...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-users mr-2"></i> Edit Dansektor</h3>
            <hr>
            <form action="#" method="post">
                <?php
                    $id = $_GET['id'];
                    $_SESSION['id_dansektor'] = $id;
                    $edit = "SELECT * FROM `dansektor` WHERE `id_dansektor` = '$id'";
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="id">ID Dansektor</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Dansubsektor" value="<?php echo $row['id_dansektor']?>" id="id" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="nama" class="form-control" placeholder="Nama" id="nama" value="<?php echo $row['nama_dansektor']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="username" class="form-control" placeholder="Username" id="username" value="<?php echo $row['username_dansektor']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="password" class="form-control" placeholder="Password" id="password" value="<?php echo $row['password_dansektor']?>">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <select name="pangkat" id="pangkat">
                                <option value='<?php echo $row["pangkat_dansektor"]?>' selected><?php echo $row['pangkat_dansektor']?></option>
                ...
                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="edit_dansektor">Submit</button>
                </div>
        </div>
    </div>
        <footer>
