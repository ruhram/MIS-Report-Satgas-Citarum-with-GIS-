...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-dumpster mr-2"></i> TPS</h3>
            <hr>
            <div id="mapid"></div>
            <br>
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM tps ORDER BY id_tps ASC";
    ...
    <script>
        ...
        //script untuk peta tematik    
            ...
            info.update = function (props) {
                this._div.innerHTML = '<h4>Jumlah TPS</h4>' +  (props ?
	        ...
	        info.addTo(map);
            <?php
                $sql = mysqli_query($conn, "SELECT * FROM tps WHERE id_subsektor = 1");
                $tps1 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM tps WHERE id_subsektor = 602");
                $tps2 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM tps WHERE id_subsektor = 603");
                $tps3 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM tps WHERE id_subsektor = 604");
                $tps4 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM tps WHERE id_subsektor = 606");
                $tps6 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM tps WHERE id_subsektor = 607");
                $tps7 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM tps WHERE id_subsektor = 608");
                $tps8 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM tps WHERE id_subsektor = 609");
                $tps9 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM tps WHERE id_subsektor = 610");
                $tps10 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM tps WHERE id_subsektor = 611");
                $tps11 = mysqli_fetch_array($sql);
            ?>
            var Tps = {"Tegalluar": <?= $tps1['jumlah']?>, "Bojongsari":<?=$tps2['jumlah']?>, "Cikoneng":<?=$tps3['jumlah']?>, "Citeureup":<?=$tps4['jumlah']?>, "Wargamekar":<?=$tps6['jumlah']?>,"Jelekong":<?=$tps7['jumlah']?>,"Manggahang":<?=$tps8['jumlah']?>,"Baleendah":<?=$tps9['jumlah']?>,"Cibisoro":<?=$tps10['jumlah']?>,"Oxbow Cijagra":<?=$tps11['jumlah']?>}
