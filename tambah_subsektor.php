...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-cube mr-2"></i> Tambah Sektor</h3>
            <hr>
            <form action="#" method="post">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Sektor" id="id">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="sektor">Nomor Sektor</label>
                        </div>
                        <div class="col-md-9">
                            <select name="sektor" id="sektor">
                                ...
                                <?php
                                    ...
                                    echo "<option value='$row[id_sektor]'>$row[nomor_sektor]</option>";
                                    }
                                ?>
                            </select>
                        </div>
                ...
                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="tambah_subsektor">Submit</button>
                </div>
        </div>
    </div>
        <footer>
