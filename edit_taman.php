...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-parachute-box mr-2"></i> Tambah Taman</h3>
            <hr>
            <form action="#" method="post">
            <?php
                $id = $_GET['id'];
                $_SESSION['id'] = $id;
                $edit = "SELECT * FROM `taman` WHERE `id_taman` = '$id'";
            ...
            ?>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="id">ID Taman</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Taman" id="id" value="<?php echo $row['id_taman']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="jumlah">Jumlah Taman</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="jumlah" class="form-control" placeholder="Jumlah Taman" id="jumlah" value="<?php echo $row['jumlah']?>">
                        </div>
                    </div>
                </div>

                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="edit_taman">Submit</button>
                </div>
            </form>
        </div>
    </div>
