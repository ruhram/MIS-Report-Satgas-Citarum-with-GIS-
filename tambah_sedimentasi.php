...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-mountain mr-2"></i> Tambah Sedimentasi Tanah</h3>
            <hr>
            ...
            <form action="#" method="post">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Sedimentasi Tanah" id="id">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="sungai" class="form-control" placeholder="Nama Sungai" id="sungai">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="panjang_sungai" class="form-control" placeholder="Panjang Sungai" id="panjang">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="lebar_sungai" class="form-control" placeholder="Lebar Sungai" id="lebar">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="tahun" class="form-control" placeholder="Tahun" id="tahun">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="volume" class="form-control" placeholder="Volume Sedimentasi" id="volume">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <textarea rows="2" cols="10" type="text" name="keterangan" class="form-control" placeholder="Keterangan" id="keterangan"></textarea>
                        </div>
                    </div>
                </div>

                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="tambah_sedimentasi">Submit</button>
                </div>
            </form>
        </div>
    </div>
