...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-cube"></i> Sektor</h3>
            <hr>
            <a href="tambah_sektor.php" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>Tambah Sektor</a>
            ...
            <?php
                ...
                echo "
                    ...
                    <td>$no</td>
                    <td>$row[id_sektor]</td>
                    <td colspan='2' class='text-center'><a href='edit_sektor.php?id=$row[id_sektor]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a>
                    <a class='m-2' href='admin_sektor.php?deletesektor=$row[id_sektor]'><i class='fas fa-trash-alt bg-danger text-white p-2 rounded'></i></a></td>
                    </tr>";
                    $no++;
                }
            ?>
