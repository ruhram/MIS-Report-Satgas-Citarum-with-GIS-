...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-bath mr-2"></i> Tambah Sanitasi</h3>
            <hr>
            <form action="#" method="post">
            <?php
                $id = $_GET['id'];
                $_SESSION['id'] = $id;
                $edit = "SELECT * FROM `sanitasi` WHERE `id_sanitasi` = '$id'";
            ...
            ?>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="id">ID Sanitasi</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Sanitasi" id="id" value="<?php echo $row['id_sanitasi']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="jumlah">Jumlah Sanitasi</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="jumlah" class="form-control" placeholder="Jumlah Sanitasi" id="jumlah" value="<?php echo $row['jumlah_sanitasi']?>">
                        </div>
                    </div>
                </div>

                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="edit_sanitasi">Submit</button>
                </div>
            </form>
        </div>
    </div>
