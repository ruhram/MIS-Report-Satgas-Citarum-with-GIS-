...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM masalah ORDER BY id_dansubsektor ASC";
                ...
                echo "
                    ...
                    <td>$row[status]</td>
                    <td class='text-center'><a href='edit_masalahadmin.php?id=$row[id_masalah]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a></td>
                    </tr>";
                    $no++;
                }
            ?>
