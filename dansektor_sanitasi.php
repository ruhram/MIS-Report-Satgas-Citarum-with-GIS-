...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-bath mr-2"></i> Sanitasi</h3>
            <hr>
            <div id="mapid"></div>
            <br>
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM sanitasi ORDER BY id_sanitasi ASC";
    ...
    <script>
        ...
        //script untuk peta tematik    
            ...
            info.update = function (props) {
                this._div.innerHTML = '<h4>Jumlah Sanitasi</h4>' +  (props ?
	        ...
	        info.addTo(map);
            <?php
                $sql = mysqli_query($conn, "SELECT * FROM sanitasi WHERE id_subsektor = 1");
                $sanitasi1 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM sanitasi WHERE id_subsektor = 602");
                $sanitasi2 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM sanitasi WHERE id_subsektor = 604");
                $sanitasi4 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM sanitasi WHERE id_subsektor = 605");
                $sanitasi5 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM sanitasi WHERE id_subsektor = 608");
                $sanitasi8 = mysqli_fetch_array($sql);
                $sql = mysqli_query($conn, "SELECT * FROM sanitasi WHERE id_subsektor = 609");
                $sanitasi9 = mysqli_fetch_array($sql);
            ?>
            var sanitasi = {"Tegalluar": <?= $sanitasi1['jumlah_sanitasi']?>, "Bojongsari":<?=$sanitasi2['jumlah_sanitasi']?>, "Citeureup":<?=$sanitasi4['jumlah_sanitasi']?>, "Bojongsoang":<?=$sanitasi5['jumlah_sanitasi']?>,"Manggahang":<?=$sanitasi8['jumlah_sanitasi']?>,"Baleendah":<?=$sanitasi9['jumlah_sanitasi']?>}
            ...
            function style(feature) {
		        return {
                    ...
                    dashArray: '3',
                    fillOpacity: 0.7,
                    fillColor: getColor(sanitasi[feature.properties.kelurahan])
                };
	        }
