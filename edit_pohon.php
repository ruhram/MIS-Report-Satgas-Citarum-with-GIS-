...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-tree mr-2"></i> Edit Pohon</h3>
            <hr>
            <form action="#" method="post">
            <?php
                $id = $_GET['id'];
                $_SESSION['id_pohon'] = $id;
                $edit = "SELECT * FROM `pohon` WHERE `id_pohon` = '$id'";
            ...
            ?>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="id">ID Pohon</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Pohon" id="id" value="<?php echo $row['id_pohon']?>" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="jenis">Jenis Pohon</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="jenis" class="form-control" placeholder="Jenis Pohon" id="jenis" value="<?php echo $row['jenis_pohon']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="jumlah">Jumlah Pohon</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="jumlah" class="form-control" placeholder="Jumlah Pohon" id="jumlah" value="<?php echo $row['jumlah_pohon']?>">
                        </div>
                    </div>
                </div>

                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="edit_pohon">Submit</button>
                </div>
            </form>
        </div>
    </div>
