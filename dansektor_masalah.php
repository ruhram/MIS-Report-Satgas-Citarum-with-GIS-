...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM masalah INNER JOIN dansubsektor ON masalah.id_dansubsektor = dansubsektor.id_dansubsektor ORDER BY masalah.tanggal ASC";
                ...
                echo "
                    ...
                    <td>$row[status]</td>
                    <td class='text-center'><a href='edit_masalahadmin.php?id=$row[id_masalah]'><i class='fas fa-edit bg-success p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a></td>
                    </tr>";
                    $no++;
                }
            ?>
