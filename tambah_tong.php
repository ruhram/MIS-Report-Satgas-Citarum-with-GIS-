...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-trash mr-2"></i> Tambah Tempat Sampah</h3>
            <hr>
            <form action="#" method="post">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Tempat Sampah" id="id">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="jumlah" class="form-control" placeholder="Jumlah Tempat Sampah" id="jumlah">
                        </div>
                    </div>
                </div>
