...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-recycle mr-2"></i> Pengumpulan Sampah</h3>
            <hr>
            <a href="tambah_sampah.php" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>Tambah Sampah</a>
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM sampah ORDER BY id_sampah ASC";
                ...
                echo "
                    ...
                    <td colspan='2' class='text-center'><a href='edit_sampah.php?id=$row[id_sampah]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a>
                    <a class='m-2' href='admin_sampah.php?deletesampah=$row[id_sampah]'><i class='fas fa-trash-alt bg-danger text-white p-2 rounded'></i></a></td>
                    </tr>";
                    $no++;
                }
            ?>
