...
<html lang="en">
  ...
  <body>
        ...
        <ul class="nav flex-column pl-3 pr-3 pb-3 p-1 pt-3" style="background-color: #BD6A11">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="admin_elemen.php"style="margin-bottom: 110px"><i class="fab fa-elementor mr-2"></i>Elemen Sektor</a>
            </li>
        </ul>
        </div>
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-cubes mr-2"></i> Subsektor</h3>
            <hr>
            <a href="tambah_subsektor.php" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>Tambah Subsektor</a>
            <table class="table table-striped table-bordered">
            <thead>
                <tr>
                <th scope="col">No</th>
                <th scope="col">ID Subsektor</th>
                <th scope="col">Nomor Subsektor</th>
                <th scope="col">Nomor Sektor</th>
                <th scope="col" colspan="2" class="text-center">Action</th>
                </tr>
            </thead>
            <tbody>
            <?php
                $query = "SELECT * FROM subsektor ORDER BY id_subsektor ASC";
                ...
                echo "
                    ...
                    <td>$row[id_sektor]</td>
                    <td colspan='2' class='text-center'><a href='edit_subsektor.php?id=$row[id_subsektor]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a>
                    <a class='m-2' href='admin_subsektor.php?deletesubsektor=$row[id_subsektor]'><i class='fas fa-trash-alt bg-danger text-white p-2 rounded'></i></a></td>
                    </tr>";
                    $no++;
                }
            ?>
