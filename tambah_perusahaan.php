...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-building mr-2"></i>Tambah Perusahaan</h3>
            <hr>
            <form action="#" method="post">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Perusahaan" id="id">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="nama" class="form-control" placeholder="Nama Perusahaan" id="nama">
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="tambah_perusahaan">Submit</button>
                </div>
            </form>
            </div>
    </div>
