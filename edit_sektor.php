  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            ...
            <form action="#" method="post">
                <?php
                    $id = $_GET['id'];
                    $edit = "SELECT * FROM `sektor` WHERE `id_sektor` = '$id'";
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Sektor" value="<?php echo $row['id_sektor']?>" id="id" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="nomor" class="form-control" placeholder="Nomor" value="<?php echo $row['nomor_sektor']?>" id="nomor">
                        </div>
                    </div>
                </div>

                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="edit_sektor">Submit</button>
                </div>
        </div>
    </div>
        <footer>
