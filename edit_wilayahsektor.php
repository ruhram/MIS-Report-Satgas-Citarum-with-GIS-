  ...
  <body>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-landmark mr-2"></i> Edit Wilayah Sektor</h3>
            <hr>
            <form action="#" method="post" enctype="multipart/form-data">
                <?php
                    $id = $_GET['id'];
                    $edit = "SELECT * FROM `wilayah_sektor` WHERE `id_wilayahsektor` = '$id'";
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Wilayah" value="<?php echo $row['id_wilayahsektor']?>" id="id" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="file" name="peta" class="form-control" placeholder="peta" id="peta" value="<?php echo $row['peta_sektor']?>">
                        </div>
                    </div>
                </div>                    
