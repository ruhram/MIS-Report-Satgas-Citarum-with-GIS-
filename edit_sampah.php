...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-recycle mr-2"></i> Edit Pengumpulan Sampah</h3>
            <hr>
            <form action="#" method="post">
                <?php
                    $id = $_GET['id'];
                    $_SESSION['id'] = $id;
                    $edit = "SELECT * FROM `sampah` WHERE `id_sampah` = '$id'";
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="id" class="form-control" placeholder="ID Sampah" id="id" value="<?php echo $row['id_sampah']?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="volume">Volume Sampah</label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" name="volume" class="form-control" placeholder="Volume Sampah" id="volume" value="<?php echo $row['volume_sampah']?>">
                        </div>
                    </div>
                </div>

                <div class="text-center mb-5">
                    <button type="submit" class="btn btn-primary p-2 pr-5 pl-5" name="edit_sampah">Submit</button>
                </div>
            </form>
        </div>
    </div>
