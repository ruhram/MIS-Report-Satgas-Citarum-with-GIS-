...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-users mr-2"></i> Dansubsektor</h3>
            <hr>
            <a href="tambah_dansubsektor.php" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>Tambah Dansubsektor</a>
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM `dansubsektor` ORDER BY id_subsektor ASC";
                ...
                echo "
                    ...
                    <td>$row[username_dansubsektor]</td>
                    <td>$row[password_dansubsektor]</td>
                    <td>$row[pangkat_dansubsektor]</td>
                    <td>$row[id_sektor]</td>
                    <td>$row[id_subsektor]</td>
                    <td colspan='2' class='text-center'><a href='edit_dansubsektor.php?id=$row[id_dansubsektor]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a>
                    <a class='m-2' href='admin_user.php?deletedansubsektor=$row[id_dansubsektor]'><i class='fas fa-trash-alt bg-danger text-white p-2 rounded'></i></a></td>
                    </tr>";
                    $no++;
                }
            ?>
