...
<html lang="en">
  ...
  <body>
        ...
        <ul class="nav flex-column pl-3 pr-3 pb-3 p-1 pt-3" style="background-color: #BD6A11">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="wilayah.php"><i class="fas fa-globe-asia mr-2"></i>Wilayah</a><hr>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="admin_elemen.php"style="margin-bottom: 135px"><i class="fab fa-elementor mr-2"></i>Elemen Sektor</a>
            </li>
        </ul>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="p-2" id="pangkat">
                        <h7><b><span style="margin-right: 38px;">Jabatan</span> <span class="mr-2">:</span> </b> <?php echo $jabatan ?></h7>
                    </div>
                </div> 
            </div>
            <br><br>
            ...
            <div class="row text-white">
                <div class="card bg-info ml-3" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <h5 class="card-title text-white">JUMLAH DANSEKTOR</h5>
                        <div class="text-white display-4">
                            <?php
                            $result = mysqli_query($conn, "SELECT * FROM dansektor");
                            $member = mysqli_num_rows($result);
                            echo"$member";
                            ?>
                        </div>
                        <a href="admin_dansektor.php"><p class="card-text text-white">Lihat Detail<i class="fas fa-angle-double-right ml-2"></i></p></a>
                    </div>
                </div>
                ...
                <div class="card bg-danger ml-3" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <a href="admin_dansubsektor.php"><p class="card-text text-white">Lihat Detail<i class="fas fa-angle-double-right ml-2"></i></p></a>
                    </div>
                </div>
                ...
                <div class="card bg-warning ml-3" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <h5 class="card-title text-white">JUMLAH ADMIN</h5>
                        <div class="text-white display-4">
                            <?php
                        ...
                        <a href="admin_admin.php"><p class="card-text text-white">Lihat Detail<i class="fas fa-angle-double-right ml-2"></i></p></a>
                    </div>
                </div>
            </div>
            <br><br><br>
