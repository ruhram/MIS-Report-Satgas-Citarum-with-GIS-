...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-users-cog"></i> Rencana Harian Komandan Subsektor</h3>
            <hr>  
            ...
            <thead>
                ...
                <th scope="col">Nama Dansektor</th>
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM rencana INNER JOIN dansubsektor ON rencana.id_dansubsektor = dansubsektor.id_dansubsektor WHERE rencana.sektor = '6' ORDER BY rencana.tanggal ASC ";
