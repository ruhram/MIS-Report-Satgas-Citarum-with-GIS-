...
<html lang="en">
  ...
  <body>
        ...
        <ul class="nav flex-column pl-3 pr-3 pb-3 p-1 pt-3" style="background-color: #FAAC0B">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="dansubsektor_masalah.php" style="margin-bottom: 280px"><i class="fas fa-exclamation-triangle mr-2 mb-5"></i>Masalah</a>
            </li>
        </ul>
        </div>
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-bullseye"></i> Target Tercapai</h3>
            <hr>
            <a href="laporan_target.php" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>Laporan Target Harian</a>
            ...
            <?php
                $id = $_SESSION["id"];
                $query = "SELECT * FROM capaian INNER JOIN rencana ON capaian.id_rencana = rencana.id_rencana WHERE capaian.id_dansubsektor = '$id'";
                ...
                echo "
                    ...
                    <td class='text-center'><a href='edit_member.php?id=$row[id_target]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a></td>
                    </tr>";
                    $no++;
                }
