...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            ...
            <hr>
            <a href="tambah_tong.php" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>Tambah Tempat Sampah</a>
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM tempatsampah ORDER BY id_subsektor ASC";
                ...
                echo "
                    ...
                    <td>$row[tahun]</td>
                    <td>$row[jumlah]</td>
                    <td colspan='2' class='text-center'><a href='edit_tempatsampah.php?id=$row[id_tempatsampah]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a>
                    <a class='m-2' href='admin_tempatsampah.php?deletetempatsampah=$row[id_tempatsampah]'><i class='fas fa-trash-alt bg-danger text-white p-2 rounded'></i></a></td>
                    </tr>";
                    $no++;
                }
            ?>
