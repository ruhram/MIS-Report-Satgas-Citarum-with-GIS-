...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-bullseye mr-2"></i> Target Tercapai</h3>
            <hr>
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM capaian INNER JOIN rencana ON capaian.id_rencana = rencana.id_rencana ORDER BY capaian.id_dansubsektor  ASC";
                ...
                echo "
                    ...
                    <td class='text-center'><a href='edit_targetadmin.php?id=$row[id_target]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a></td>
                    </tr>";
                    $no++;
                }
