...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-monument mr-2"></i> Wilayah Subsektor</h3>
            <hr>
            <a href="tambah_wilayahsubsektor.php" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>Tambah Wilayah Subsektor</a>
            ...
            <tbody>
            <?php
                $query = "SELECT * FROM wilayah_subsektor ORDER BY id_wilayahsubsektor ASC";
                ...
                echo "
                    ...
                    <td>$row[peta_subsektor]</td>
                    <td colspan='2' class='text-center'><a href='edit_wilayahsubsektor.php?id=$row[id_wilayahsubsektor]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a>
                    <a class='m-2' href='wilayah.php?deletewilayahsubsektor=$row[id_wilayahsubsektor]'><i class='fas fa-trash-alt bg-danger text-white p-2 rounded'></i></a></td>
                    </tr>";
                    $no++;
                }
