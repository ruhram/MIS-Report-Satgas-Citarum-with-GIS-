...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            <h3><i class="fas fa-project-diagram"></i> Rencana Harian</h3>
            <hr>
            <a href="tambah_rencana.php" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>Tambah Rencana</a>
            ...
            <?php
                $id = $_SESSION["id"];
                $query = "SELECT * FROM `rencana` WHERE `id_dansubsektor` = '$id'";
                ...
                echo "
                    ...
                    <td>$row[id_lokasi]</td>
                    <td>$row[status]</td>
                    <td class='text-center'><a href='edit_member.php?id=$row[id_rencana]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a></td>
                    </tr>";
                    $no++;
                }
