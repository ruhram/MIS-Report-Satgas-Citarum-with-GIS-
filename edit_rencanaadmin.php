  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            ...
            <form action="#" method="post">
                <?php
                    $id = $_GET['id'];
                    $edit = "SELECT * FROM `rencana` WHERE `id_rencana` = '$id'";
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <textarea rows="5" cols="10" name="deskripsi" class="form-control" placeholder="Deskrispi" id="deskripsi"><?php echo $row['deskripsi']?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <textarea rows="2" cols="10" name="target" class="form-control" placeholder="Target" id="target"><?php echo $row['target']?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="lokasi" class="form-control" placeholder="Lokasi" id="lokasi"  value="<?php echo $row['id_lokasi']?>">
                        </div>
                    </div>
                </div>
