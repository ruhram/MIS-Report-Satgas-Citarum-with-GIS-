...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 p-5">
            ...
            <hr>
            <a href="tambah_taman.php" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>Tambah Format Taman</a>
            ...
            <?php
                ...
                echo "
                    ...
                    <td>$row[tahun]</td>
                    <td>$row[jumlah]</td>
                    <td colspan='2' class='text-center'><a href='edit_taman.php?id=$row[id_taman]'><i class='fas fa-edit bg-warning p-2 text-white rounded mr-0' data-toggle='tooltip' title='edit'></i></a>
                    <a class='m-2' href='admin_taman.php?deletetaman=$row[id_taman]'><i class='fas fa-trash-alt bg-danger text-white p-2 rounded'></i></a></td>
                    </tr>";
                    $no++;
                }
            ?>
